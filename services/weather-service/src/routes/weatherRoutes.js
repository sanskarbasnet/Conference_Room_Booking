...
router.get('/weather-service/forecast/:locationId/:date', weatherController.getForecast);

// Get bulk forecasts
router.post('/forecast/bulk', weatherController.getBulkForecasts);
router.post('/weather-service/forecast/bulk', weatherController.getBulkForecasts);

// Clear forecast cache
router.delete('/forecast/:locationId/:date', weatherController.clearForecastCache);
router.delete('/weather-service/forecast/:locationId/:date', weatherController.clearForecastCache);
